    ...
    <form method="POST" action="añadir_claves2.php">
      ...
      <div id="paginacion">
        ...
        <ul class="pagination d-flex justify-content-center">
          ...
          <a class="page-link btnanadir">&laquo;</a>
        ...
        for ($i = 0; $i < $paginas; $i++) { ?>
          ...
          <a class="page-link btnanadir">
            <!--href="añadir_claves.php?pagina=<?PHP //echo $i + 1 ?>"-->
            <?PHP
            echo $i + 1;
            ?>
          </a>
      ...
      <a class="page-link btnanadir">&raquo;</a>
      <!--href="añadir_claves.php?pagina=<?PHP //echo $_GET['pagina'] + 1 ?>"-->
    </li>
  </ul>
</div>
</body>
